...
const props = defineProps({ camera: Object, buildings: Array, rooms: Array });

const form = useForm({
  building_id: props.camera.building_id,
  room_id: props.camera.room_id || '',
  ...
  is_public: !!props.camera.is_public,
});

const submit = () => form.put(route('admin.cameras.update', props.camera.id));
</script>
...
<template>
  <AdminLayout>
    ...
    <div class="max-w-3xl">
      <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">Edit Camera</h1>
